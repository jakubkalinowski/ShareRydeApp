        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(GPS_Location.this, "Best Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(GPS_Location.this, "Network Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(GPS_Location.this, "GPS Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
